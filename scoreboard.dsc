    ...
    presets:
        ...
        default:
            ...
            lines:
                stats:
                    text:
                    - <&sp.repeat[5].strikethrough.color_gradient[from=red;to=yellow]><reset> <gray><bold>Server&player:<reset> <&sp.repeat[5].strikethrough.color_gradient[from=yellow;to=red]>
                    - <dark_red>• <red>ping: <white><placeholder[player_ping]> <red>ms <gray>| <red>money: <white><player.formatted_money><yellow> ⛁ 
                    - <dark_red>• <red>name: <white><placeholder[player_name]> <gray>| <red>online: <white><placeholder[server_online]>
                    - <&sp.repeat[9].strikethrough.color_gradient[from=red;to=yellow]><reset> <gray><bold>rpg info: <reset><&sp.repeat[9].strikethrough.color_gradient[from=yellow;to=red]>
                    - <dark_red>• <red>kinghill level: <white><placeholder[iridiumskyblock_current_level]> <red>kh level: <white><placeholder[iridiumskyblock_current_value]>
                    - <dark_red>• <red>kinghill rank: <white><placeholder[iridiumskyblock_island_rank]> <red>kh name<&co>
                    - <dark_red>• <white><placeholder[iridiumskyblock_island_name]>
                    - <dark_red>• <red>current quest<&co>
                    - <dark_red>• <placeholder[quests_player_compass_quest_objectives]>
                    - <dark_red>• <red>class: <white><placeholder[mmocore_class]>
                    - <dark_red>• <red>level: <white><placeholder[mmocore_level]> <gray>--> <white><placeholder[mmocore_level_percent]><yellow>/100%
                    - <empty>
                rpg:
                    text:
                    - <gray>kinghills.xyz
